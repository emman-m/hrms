...
<body>
                    ...
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./illustrations.html">
                                <span
                                    class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/brand-figma -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="icon">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-10">
                                            ...
                                            <div class="markdown text-secondary">
                                                ...
                                                download any of the 5754 icons in SVG, PNG or&nbsp;React and use them in
                                ...
                                <li class="list-inline-item">
                                    <a href="https://github.com/sponsors/codecalm" target="_blank"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            class="icon text-pink icon-inline">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            <path
                                                d="M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572" />
                                        </svg>
    ...
    <!-- Libs JS -->
    <script src="./dist/libs/apexcharts/dist/apexcharts.min.js?1733768793" defer></script>
    <script src="./dist/libs/jsvectormap/dist/jsvectormap.min.js?1733768793" defer></script>
    <script src="./dist/libs/jsvectormap/dist/maps/world.js?1733768793" defer></script>
    <script src="./dist/libs/jsvectormap/dist/maps/world-merc.js?1733768793" defer></script>
    <!-- Tabler Core -->
    <script src="./dist/js/tabler.min.js?1733768793" defer></script>
    <script src="./dist/js/demo.min.js?1733768793" defer></script>
    
    <script defer
        src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ=="
        data-cf-beacon='{"rayId":"8f8ed05a89600968","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"version":"2024.10.5","token":"84cae67e72b342399609db8f32d1c3ff"}'
